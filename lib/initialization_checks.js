      ...
      body: {
        ...
        fields: JSON.stringify([
          ...
          { name: 'bucket_influencers.influencer_field_name', type: 'string', count: 0, scripted: false, indexed: true, analyzed: false,
            doc_values: true, searchable: true, aggregatable: true },
          { name: 'quantiles.quantile_state', type: 'string', count: 0, scripted: false, indexed: false, analyzed: false,
            doc_values: false, searchable: false, aggregatable: false },
          { name: 'quantile_state', type: 'string', count: 0, scripted: false, indexed: false, analyzed: false,
            doc_values: false, searchable: false, aggregatable: false }
        ]),
        // The "Short Dots" format stops large quantiles strings from hanging Chrome
        fieldFormatMap: '{"quantiles.quantile_state":{"id":"string","params":{"transform":"short"}},' +
          '"quantile_state":{"id":"string","params":{"transform":"short"}}}'
      }
    }, (error) => {
      if (error) {
