...
module.exports = function (plugin, server) {
  ...
  const ML_INTERNAL_INDEX_ID = 'ml-int';
      ...
      body: {
        ...
        fields: JSON.stringify([
          ...
          { name: 'initial_anomaly_score', type: 'number', count: 0, scripted: false, indexed: true, analyzed: false,
            doc_values: true, searchable: true, aggregatable: true },
          { name: 'max_normalized_probability', type: 'number', count: 0, scripted: false, indexed: true, analyzed: false,
            doc_values: true, searchable: true, aggregatable: true },
          ...
          { name: 'influencer_field_name', type: 'string', count: 0, scripted: false, indexed: true, analyzed: false,
            doc_values: true, searchable: true, aggregatable: true },
          { name: 'influencer_field_value', type: 'string', count: 0, scripted: false, indexed: true, analyzed: true,
            doc_values: false, searchable: true, aggregatable: true },
          { name: 'field_name', type: 'string', count: 0, scripted: false, indexed: true, analyzed: false,
            doc_values: true, searchable: true, aggregatable: true },
          { name: 'initial_normalized_probability', type: 'number', count: 0, scripted: false, indexed: true, analyzed: false,
            doc_values: true, searchable: true, aggregatable: true },
          { name: 'by_field_value', type: 'string', count: 0, scripted: false, indexed: true, analyzed: true,
            doc_values: false, searchable: true, aggregatable: true },
          ...
          { name: 'detector_index', type: 'number', count: 0, scripted: false, indexed: true, analyzed: false,
            doc_values: true, searchable: true, aggregatable: true },
          { name: 'over_field_value', type: 'string', count: 0, scripted: false, indexed: true, analyzed: true,
            doc_values: false, searchable: true, aggregatable: true },
          { name: 'partition_field_value', type: 'string', count: 0, scripted: false, indexed: true, analyzed: true,
            doc_values: false, searchable: true, aggregatable: true },
          { name: 'normalized_probability', type: 'number', count: 0, scripted: false, indexed: true, analyzed: false,
            doc_values: true, searchable: true, aggregatable: true },
          ...
          { name: 'actual', type: 'number', count: 0, scripted: false, indexed: true, analyzed: false,
            doc_values: true, searchable: true, aggregatable: true },
          { name: 'debug_upper', type: 'number', count: 0, scripted: false, indexed: true, analyzed: false,
            doc_values: true, searchable: true, aggregatable: true },
          { name: 'debug_lower', type: 'number', count: 0, scripted: false, indexed: true, analyzed: false,
            doc_values: true, searchable: true, aggregatable: true },
          { name: 'debug_median', type: 'number', count: 0, scripted: false, indexed: true, analyzed: false,
            doc_values: true, searchable: true, aggregatable: true },
          { name: 'debug_feature', type: 'string', count: 0, scripted: false, indexed: true, analyzed: false,
            doc_values: true, searchable: true, aggregatable: true },
          { name: 'causes.function', type: 'string', count: 0, scripted: false, indexed: true, analyzed: false,
            doc_values: true, searchable: true, aggregatable: true },
          { name: 'causes.partition_field_value', type: 'string', count: 0, scripted: false, indexed: true, analyzed: true,
            doc_values: false, searchable: true, aggregatable: true },
          ...
          { name: 'causes.probability', type: 'number', count: 0, scripted: false, indexed: true, analyzed: false,
            doc_values: true, searchable: true, aggregatable: true },
          { name: 'causes.by_field_value', type: 'string', count: 0, scripted: false, indexed: true, analyzed: true,
            doc_values: false, searchable: true, aggregatable: true },
          ...
          { name: 'causes.field_name', type: 'string', count: 0, scripted: false, indexed: true, analyzed: false,
            doc_values: true, searchable: true, aggregatable: true },
          { name: 'causes.over_field_value', type: 'string', count: 0, scripted: false, indexed: true, analyzed: true,
            doc_values: false, searchable: true, aggregatable: true },
          ...
          { name: 'influencers.influencer_field_name', type: 'string', count: 0, scripted: false, indexed: true, analyzed: false,
            doc_values: true, searchable: true, aggregatable: true },
          { name: 'influencers.influencer_field_values', type: 'string', count: 0, scripted: false, indexed: true, analyzed: true,
            doc_values: false, searchable: true, aggregatable: true },
  ...
  function checkForMlInternalIndexPattern() {
    return callWithInternalUser('exists', {
      index: config.get('kibana.index'),
      type: 'index-pattern',
      id: ML_INTERNAL_INDEX_ID
    }).then((resp) => {
      if (resp !== true) {
        plugin.status.yellow('No ml-int index pattern found - creating index pattern');
        createMlInternalIndexPattern();
      }
    });
  }

  function createMlInternalIndexPattern() {
    return callWithInternalUser('create', {
      index: config.get('kibana.index'),
      type: 'index-pattern',
      id: ML_INTERNAL_INDEX_ID,
      body: {
        title : ML_INTERNAL_INDEX_ID,
        timeFieldName: 'timestamp',
        fields: JSON.stringify([
          { name: '_index', type: 'string', count: 0, scripted: false, indexed: false, analyzed: false,
            doc_values: false, searchable: false, aggregatable: false },
          ...
          { name: 'total_jobs', type: 'number', count: 0, scripted: false, indexed: true, analyzed: false,
            doc_values: true, searchable: false, aggregatable: false },
          { name: 'total_detectors', type: 'number', count: 0, scripted: false, indexed: true, analyzed: false,
            doc_values: true, searchable: false, aggregatable: false },
          { name: 'running_jobs', type: 'number', count: 0, scripted: false, indexed: true, analyzed: false,
            doc_values: true, searchable: false, aggregatable: false },
          { name: 'running_detectors', type: 'number', count: 0, scripted: false, indexed: true, analyzed: false,
            doc_values: true, searchable: false, aggregatable: false }
        ])
      }
    }, (error) => {
      if (error) {
        plugin.status.red('Error creating index pattern ml-int');
        console.log('Error creating index pattern ml-int:', error);
      }
    });
  }
  ...
  function check() {
    const healthCheck =
      ...
      .then(checkForMlInternalIndexPattern)
