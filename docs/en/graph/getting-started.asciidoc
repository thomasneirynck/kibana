...
response code:
+
image::graph-url-connections.jpg["URL connections"]
...
image:graph-expand-button.jpg[Expand Selection] to display additional vertices
that connect to your graph. Click the Link button 
image:graph-link-button.jpg[Add links to existing terms] to display additional
...
image:graph-undo-button.jpg[Undo]. 
