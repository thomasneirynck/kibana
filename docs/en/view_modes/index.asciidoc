...
image:view_modes/images/all_apps_default_mode.png["All Apps View Mode"]
...
image:view_modes/images/view_only_listing_page.png["View Only Dashboard Listing Page"]

When you view a dashboard in *View dashboards only mode*, no editing tools are available.
image:view_modes/images/view_only_dashboard.png["View Only Dashboard"]
