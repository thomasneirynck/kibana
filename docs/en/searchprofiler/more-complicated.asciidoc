...
+
image::images/gs7.png["Using the index filter"]
...
+
image::images/gs8.png["Profiling the more complicated query"]
+
...
+
image::images/gs9.png["Drilling into the first shard's details"]
+
...
image::images/gs10.png["Drilling into the first shard's details"]
...
how to interpret various results, see the {ref}/_profiling_queries.html[Profile Reference Documentation]
