...
+
image::gs7.png["Using the index filter"]
...
+
image::gs8.png["Profiling the more complicated query"]
+
...
+
image::gs9.png["Drilling into the first shard's details"]
+
...
image::gs10.png["Drilling into the first shard's details"]
